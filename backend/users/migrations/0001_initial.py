    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[django.core.validators.RegexValidator(code='invalid_username', message="Имя пользователя не может быть 'me' и должно содержать только буквы и цифры.", regex='^(?!me$)[a-zA-Z0-9]+$')], verbose_name='Имя пользователя')),
